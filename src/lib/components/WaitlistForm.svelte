...
<!-- Modal overlay -->
<button
    class="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center z-50"
    style="padding-top: 588px; padding-left: 205px;"
    on:click={handleClose}
>
    <!-- Modal content -->
    <button class="bg-white shadow-lg p-6 w-full max-w-md mx-4 relative" on:click|stopPropagation>
        <!-- Close button -->
        <button
            on:click={handleClose}
